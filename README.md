...
- **Word data** (`data/teps_words.csv`): A hand-curated TEPS vocabulary list. Besides meaning/example sentence/translated example, some entries also include well-known collocation hints.
